...
<h1 class="h3 mb-4 text-gray-800" dir="{{ app()->getLocale() == "ar" ? "rtl" : "" }}">{{ __('Products') }}</h1>
...
<div class="card p-2" dir="{{ app()->getLocale() == "ar" ? "rtl" : "" }}">
    <div class="container-fluid mt-5">
        <div class="row {{ app()->getLocale() == "ar" ? "me-1" : "ms-1" }} mb-2">
            ...
            <button class="btn btn-icon btn-outline-primary m-1" id="" data-bs-toggle="modal" data-bs-target="#createProductModal"><span class="mdi mdi-plus-outline"></span></button>
...
<script type="text/javascript">
        ...
        function showContextMenu(id, x, y) {
            ...
            var contextMenu = $('<ul class="context-menu" dir="{{ app()->isLocale("ar") ? "rtl" : "" }}"></ul>')
                .append('<li><a onclick="demoProduct(' + id + ')"><i class="tf-icons mdi mdi-pencil-outline {{ app()->isLocale("ar") ? "ms-1" : "me-1" }}"></i>{{ __("Demo") }}</a></li>')
            ...
            table = $('#table').DataTable({
                ...
                rowCallback: function(row, data) {
                    ...
                    $(row).on('dblclick', function() {
                        window.location.href = "{{ url('product') }}/" + data.id;
                    });
            ...
            $('#createProductForm').submit(function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#createProductForm .form-control').removeClass('valid');
                        $('#createProductForm .form-select').removeClass('valid');
                        table.ajax.reload();
                    },
